                ...
                <div className="flex-1 min-w-0 flex items-center gap-3">
                    <div className="flex flex-col min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                            <span className={cn("text-[9px] font-black uppercase tracking-widest", providerInfo.color)}>
                                {providerInfo.name}
                            </span>
                            <span className="text-[9px] text-gray-600 font-mono">• {formatDate(session.createdAt)}</span>
                        </div>
                    </div>
                </div>
                    ...
                    {session.proxy?.externalIp ? (
                        <>
                            ...
                            <span className="text-[9px] text-gray-500 uppercase tracking-widest mt-0.5 truncate">
                                {session.proxy.city || "Unknown"}, {session.proxy.country || "Secure"}
                            </span>
                        </>
                    ) : (
                                ...
                                {transitionData.logs.map((log, i) => (
                                    <motion.div
                                        ...
                                        className={cn(
                                            ...
                                            i === transitionData.logs.length - 1 ? "text-primary font-bold" : "text-gray-500/60"
                                        )}
                                    >
