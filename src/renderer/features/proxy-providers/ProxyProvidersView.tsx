        ...
        <div className="space-y-8 p-1">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    >
                        <RefreshCw className={cn("w-4 h-4 text-primary transition-transform duration-500", isLoading && "animate-spin")} />
                    ...
                    >
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest whitespace-nowrap">Connect Provider</span>
                    </button>
                </div>
            </div>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            <div className={cn(
                                ...
                                testResult.success ? "bg-emerald-500/20 border-emerald-500/30" : "bg-red-500/20 border-red-500/30"
                            )}>
                                {testResult.success ? <CheckCircle2 className="w-5 h-5" /> : <AlertCircle className="w-5 h-5" />}
                            </div>
                            <div>
                                <h4 className="text-[10px] font-black uppercase tracking-widest opacity-60">Test Result: {testResult.provider}</h4>
                ...
                {!isLoading && providers.length < 3 && (
                    ...
                    >
                        ...
                        <div className="text-center">
                            <h3 className="text-sm font-black text-white uppercase tracking-widest">Connect New Node</h3>
                            <p className="text-[10px] text-gray-500 font-bold uppercase tracking-tight mt-1">Expand your rotation pool capacity</p>
                        </div>
                    </motion.button>
                )}
            </div>
            ...
            {isLoading && providers.length === 0 && (
                <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                    {[1, 2, 3].map((i) => (
                        <div key={i} className="glass-container rounded-[32px] h-[340px] animate-pulse bg-white/5" />
                    ))}
                </div>
            )}
