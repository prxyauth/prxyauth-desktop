...
export const apiKeyApi = {
     ...
     */
    generate: async (data: GenerateApiKeyRequest): Promise<GenerateApiKeyResponse> => {
...
export const proxyApi = {
     ...
     */
    add: async (data: ProxyConfig & { validate?: boolean }): Promise<ProxyPoolResponse> => {
...
export const proxyProviderApi = {
    ...
    list: async (): Promise<ProxyProviderConfig[]> => {
        const response = await apiFetch<ProxyProviderListResponse>("/api/settings/proxy-providers");
        return response.data || [];
    },
     ...
     */
    save: async (data: SaveProviderRequest): Promise<ProxyProviderSaveResponse> => {
        return apiFetch<ProxyProviderSaveResponse>("/api/settings/proxy-providers", {
            method: "POST",
            body: data,
        });
    },
     ...
     */
    remove: async (provider: ProxyProviderType): Promise<{ success: boolean; message?: string }> => {
     ...
     */
    toggle: async (provider: ProxyProviderType, enabled: boolean): Promise<{ success: boolean; message?: string }> => {
     ...
     */
    test: async (provider: ProxyProviderType): Promise<ProxyProviderTestResponse> => {
        return apiFetch<ProxyProviderTestResponse>(`/api/settings/proxy-providers/${provider}/test`, {
            method: "POST",
        });
    },
};
...
export const notificationApi = {
    ...
    getSettings: async (): Promise<NotificationSettings> => {
        return apiFetch<NotificationSettings>("/api/settings/notifications/settings");
    },

    /**
     * Save notification settings
     */
    saveSettings: async (data: SaveNotificationRequest): Promise<{ message: string }> => {
        return apiFetch<{ message: string }>("/api/settings/notifications/settings", {
            method: "POST",
            body: data,
        });
    },
     ...
     */
    testSettings: async (data: SaveNotificationRequest): Promise<{ message: string }> => {
...
export const billingApi = {
    ...
    /**
     * List all active provider licenses
     */
    listLicenses: async (): Promise<string[]> => {
        const response = await apiFetch<{
            success: boolean;
            data: { activeProviders: string[] };
