...
export function MainLayout() {
    ...
    const renderView = () => {
        switch (activeTab) {
            case "sessions":
                return <DashboardView onNavigateToSession={handleNavigateToSession} searchQuery={searchQuery} />;
            case "session-detail":
                return selectedSessionId ? (
                    ...
                    <DashboardView onNavigateToSession={handleNavigateToSession} searchQuery={searchQuery} />
                );
            case "proxies":
                return <ProxiesView />;
